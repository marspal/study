...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/OrderDetail.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Order(orderId_, date_, custname_, phone_, orderDetail_) {
    this.orderId = 0;
    this.date = new Date();
...
var orderDetailOne = new OrderDetail_1.default(10, "电视剧", 5000, 3);
var orderDetailTwo = new OrderDetail_1.default(11, "桌子", 2000, 4); // let orderDetailThree = new OrderDetail(12, "椅子", 2500, 5);

var order = new Order(1, orderDate, "李武", "3333", [orderDetailOne, orderDetailTwo]);
console.log(order);
exports.default = order;
},{"./OrderDetail":"src/OrderDetail.ts"}],"src/app.ts":[function(require,module,exports) {
"use strict";
...
var count = "123";
console.log(Order_1.default, "aasss");
